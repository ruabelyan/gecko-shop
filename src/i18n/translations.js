export const translations = {
    en: {
        ...
        'available.subtitle': 'Browse our current selection of Eublepharis species ready for their new homes.',
        ...
        // Filter
        'filter.all': 'All Species',
        'filter.leopard': 'Leopard Geckos',
        'filter.iraqi': 'Iraqi Geckos',
    ...
    es: {
        ...
        'available.subtitle': 'Explora nuestra selección actual de especies Eublepharis listas para sus nuevos hogares.',

        // Product
        'product.species': 'Especie',
        'product.morph': 'Morfo',
        'product.age': 'Edad',
        ...
        // Filter
        'filter.all': 'Todas las Especies',
        'filter.leopard': 'Gecos Leopardo',
        'filter.iraqi': 'Gecos Iraquíes',
    ...
    ru: {
        ...
        'available.subtitle': 'Просмотрите наш текущий выбор видов Eublepharis, готовых к переезду в новые дома.',
        ...
        // Filter
        'filter.all': 'Все виды',
        'filter.leopard': 'Гекконы-Леопарды',
        'filter.iraqi': 'Иракские Гекконы',
        ...
        // Age options
        'age.juvenile': 'Молодой',
        'age.subadult': 'Подросток',
        'age.adult': 'Взрослый',
    ...
    hy: {
        ...
        'common.available': 'Առկա է',
        'common.soldOut': 'Վաճառված է',
        'common.addToCart': 'Ավելացնել Զամբյուղ',
        'common.viewDetails': 'Մանրամասներ',
        ...
        'available.subtitle': 'Պտտել մեր ներկայիս ընտրությունը Eublepharis տեսակների, պատրաստ նոր տներին:',

        // Product
        'product.species': 'Տեսակ',
        'product.morph': 'Մորֆ',
        'product.age': 'Տարիք',
        'product.gender': 'Սեռ',
        'product.description': 'Նկարագրություն',
        'product.category': 'Կատեգորիա',

        // Filter
        'filter.all': 'Բոլոր Տեսակները',
        'filter.leopard': 'Ներառական Մեխանիկներ',
        'filter.iraqi': 'Իրաքյան Մեխանիկներ',
        ...
        // Age options
        'age.juvenile': 'Երիտասարդ',
        'age.subadult': 'Կեսահասակ',
        'age.adult': 'Մեծահասակ',

        // Gender
        'gender.male': 'Արական',
        'gender.female': 'Իգական',
        'gender.unknown': 'Անհայտ',
...
export const supportedLanguages = ['en', 'es', 'ru', 'hy'];
